    ...
    this.model = [
      ...
      { label: 'access', icon: 'fa fa-fw fa-home', routerLink: ['/access'] },
      {
        ...
        items: [
          ...
          { label: 'Login Page', icon: 'fa fa-fw fa-sign-in', routerLink: ['/login'] },
          { label: 'Error Page', icon: 'fa fa-fw fa-exclamation-circle', routerLink: ['/error'] },
          { label: '404 Page', icon: 'fa fa-fw fa-times', routerLink: ['/404'] },
